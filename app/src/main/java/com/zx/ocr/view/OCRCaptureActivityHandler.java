...
import com.zx.ocr.view.decode.DecodeThread;
...
public final class OCRCaptureActivityHandler extends Handler {
    ...
    private static final String TAG = OCRCaptureActivityHandler.class.getSimpleName();
    ...
    public OCRCaptureActivityHandler(OCRCaptureActivity activity, CameraManager cameraManager, boolean isContinuousModeActive) {
